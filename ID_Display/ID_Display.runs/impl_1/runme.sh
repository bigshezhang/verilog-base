...
HD_PWD='C:/Users/Administrator/Desktop/Code/verilog-base/ID_Display/ID_Display.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log id_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source id_display.tcl -notrace
