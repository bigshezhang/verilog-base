...
HD_PWD='C:/Users/Administrator/Downloads/LANDrop/Seg-Time-Display/Seg-Time-Display.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log time_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source time_display.tcl -notrace
