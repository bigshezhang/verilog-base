...
HD_PWD='C:/Users/Administrator/Downloads/LANDrop/Seg-Time-Display/Seg-Time-Display.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log time_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source time_display.tcl
