...
HD_PWD='C:/Users/Administrator/Downloads/LANDrop/Seg_Display/Seg_Display.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_seg_controler.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multi_seg_controler.tcl -notrace
