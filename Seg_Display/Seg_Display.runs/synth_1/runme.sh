...
HD_PWD='C:/Users/Administrator/Downloads/LANDrop/Seg_Display/Seg_Display.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multi_seg_controler.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multi_seg_controler.tcl
